...
class BTLEPeripheralViewController: UIViewController, CBPeripheralManagerDelegate, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        transferData = locationMsg.data(using: String.Encoding.utf8)
    }
    ...
    */
    fileprivate func sendData() {
        ...
        while didSend {
            ...
            //[MAX-MODIFIED]
            //var bytes_temp2 = UnsafePointer<UInt32>(bytes_temp1 as UnsafeRawPointer)
            //var bytes_temp2 = UnsafePointer<UInt32>((bytes_temp1 as UnsafeRawPointer).assumingMemoryBound(to: UInt32))
    ...
    */
    ...
    func peripheralManager(_ peripheral: CBPeripheralManager,
        ...
        transferCharacteristic!.value = transferData
        print("transferCharacteristic.value changed.")
    }
}
